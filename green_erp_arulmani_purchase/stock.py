...
#         if tax_id:
    ...
    #                 'invoice_line_tax_id': [(6, 0, [tax_id])],
                ...
                'name': move_line.description or '' # TPT - BY BalamuruganPurushothaman on 16/10/2015 
...
#                 res[line.id]['line_net'] = tax_tds_amount
        return res  
    def tax_supplier_invo(self, cr, uid, ids, field_name, args, context=None):
        res = {}
        amount_basic = 0.0
        amount_p_f=0.0
        amount_ed=0.0
