...

{
    ...
    'data': [
        ...
        'report/acl_report.xml',
        'report/month_wise_consumption_report_view.xml',
        'report/journal_book_report_view.xml',
        'report/maintenance_order_expense_report_view.xml',
        ...
        'wizard/acl_report.xml',
        'wizard/month_wise_consumption_report_view.xml',
        'wizard/journal_book_report_view.xml',
        'wizard/maintenance_order_expense_report_view.xml',
        'hr_payroll_view.xml',
        'menu.xml',
