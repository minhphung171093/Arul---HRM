                ...
                for i,data1 in enumerate(L):
                    ...
                    if employee_ids and date:
                        if data1[:3]=='P10':
                            ...
                            val1={'employee_id':employee_ids[0],'planned_work_shift_id':0,'work_date':date,'in_time':in_time,'out_time':0,'approval':1}
                            for j,data2 in enumerate(L2):
                                ...
                                if employee_code_2==employee_code and date==date_2 and in_out=='P20':
                                    ...
                                    val1['planned_work_shift_id']=planed_work_shift
