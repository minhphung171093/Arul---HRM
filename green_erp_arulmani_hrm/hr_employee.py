...
#                     'payroll_area_id':emp.payroll_area_id.id,
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if context.get('create_promotion_employee'):
            action_history = self.browse(cr, uid, new_id)
            if action_history.employee_category_to_id and action_history.employee_category_to_id.id or action_history.employee_category_id.id:
                if action_history.employee_category_to_id and action_history.employee_category_to_id.code=='S1' :
                    payroll_area = 2
                if action_history.employee_category_to_id and action_history.employee_category_to_id.code=='S2':
                    payroll_area = 1
                if action_history.employee_category_to_id and action_history.employee_category_to_id.code=='S3':
                    payroll_area = 3
            self.pool.get('hr.employee').write(cr, uid, [action_history.employee_id.id], {#'employee_category_id': action_history.employee_category_id and action_history.employee_category_id.id or False,
               ...
               'payroll_area_id': payroll_area or False
               },
                                                                                          )
