...
class Parser(report_sxw.rml_parse):
    ...
    def get_move_ids(self):
        ...
        sql = '''
                        ...
                        cast(round((cast(coalesce(ail.fright,0) As decimal(8,2))*quantity)*at.amount/100,2) As decimal(8, 2))
                        else
                        cast(round((cast(coalesce(ail.fright,0) As decimal(8,2)))*at.amount/100,2) As decimal(8, 2))
                        end
                        ...
                        where am.date between '%s' and '%s' and am.state != 'cancel'                      
        '''%(date_from,date_to)
