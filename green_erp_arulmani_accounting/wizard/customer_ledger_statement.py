    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        for line in get_invoice(cls):
            cls_line.append((0,0,{
                ...
                'sale_order_no': get_so_no(line.move_id.id, line.move_id.doc_type) + ' - ' + convert_date_cash(get_so_date(line.move_id.id, line.move_id.doc_type)),
...
#         'bill_date': fields.date('Bill Date'),
        'bill_date': fields.char('Bill Date', size = 1024),  
