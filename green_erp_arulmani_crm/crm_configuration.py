...
#         return self.name_get(cr, user, ids, context=context)
    ...
    _columns = {
        'arulmani_type': fields.selection([('export','Export'),('domestic','Domestic'),('indirect_export','Indirect Export')],'Type'),
        ...
        'range': fields.char('Range',size=128),
        'division': fields.char('Division',size=128),
        'commissionerate': fields.char('Commissionerate',size=128),
