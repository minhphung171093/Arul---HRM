...
#===============================================================================
    def config_GRN_7438(self, cr, uid, ids, context=None):
        ...
        picking_obj = self.pool.get('stock.picking')
        move_obj = self.pool.get('account.move')
        for grn in ['VVTI/GRN/018438/2016','VVTI/GRN/017735']:#['VVTI/GRN/015187/2016','VVTI/GRN/015305/2016','VVTI/GRN/015329/2016','VVTI/GRN/015424/2016']:#['VVTi/GRN/00000773']['VVTI/GRN/014480/2016']:#['VVTI/GRN/012944/2016']:#['VVTi/GRN/010906/2016']:#['VVTi/GRN/00010161']:#['VVTi/GRN/00010472']:# ['VVTi/GRN/00007438']:#['VVTi/GRN/00004321']:  #['VVTi/GRN/00003451','VVTi/GRN/00003883',]  :#['VVTI/GRN/015581/2016']
            sql = '''
                select id from stock_picking where name = '%s'
            '''%(grn)
            cr.execute(sql)
...
class tpt_update_avg_cost(osv.osv):
    ...
    def adj_goods_issue(self, cr, uid, ids, context=None):
        ...
        return self.write(cr, uid, ids, {'result':'TPT update ISSUE for report Done'})
    #
    def adj_goods_issue_coal_prd(self, cr, uid, ids, context=None):
        sql = '''
          select  mp.id as production_id, round(st.product_qty*st.price_unit, 2) as total
            from stock_move st
            inner join mrp_production mp on st.name=mp.name
            where st.state='done' and st.location_id=15 and st.product_id=10756
            and to_date(to_char(date, 'YYYY-MM-DD'), 'YYYY-MM-DD') between '2015-04-01' and '2016-03-31'
