...
#===============================================================================
    def config_GRN_7438(self, cr, uid, ids, context=None):
        ...
        picking_obj = self.pool.get('stock.picking')
        move_obj = self.pool.get('account.move')
        for grn in ['VVTI/GRN/015581/2016']:#['VVTI/GRN/015187/2016','VVTI/GRN/015305/2016','VVTI/GRN/015329/2016','VVTI/GRN/015424/2016']:#['VVTi/GRN/00000773']['VVTI/GRN/014480/2016']:#['VVTI/GRN/012944/2016']:#['VVTi/GRN/010906/2016']:#['VVTi/GRN/00010161']:#['VVTi/GRN/00010472']:# ['VVTi/GRN/00007438']:#['VVTi/GRN/00004321']:  #['VVTi/GRN/00003451','VVTi/GRN/00003883']
            sql = '''
                select id from stock_picking where name = '%s'
            '''%(grn)
            cr.execute(sql)
